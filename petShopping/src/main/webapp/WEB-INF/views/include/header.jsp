...
<style>
    ...
    #sub-1{
        ...
        height : 50%;
        margin-right : auto;
        background-image: url(/pet/resources/img/메인이미지.jpg);
    ...
    #sub-2{
        ...
        margin-left : auto;
        height : 40%;
        background-image: url(/pet/resources/img/간식모음.jpg);
        background-size: cover;
        background-repeat: none;
    }
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="#">
      	<img class="img-fluid" src="/pet/resources/img/강아지로고.jpg" 
      	     alt="로고없음" style="width:200px; height:100px;" />
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">고객센터</a>
          </li>
          <li class="nav-item">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title">
					<span style="color: #52b1ff;">PET</span> 로그인
				</h4>
